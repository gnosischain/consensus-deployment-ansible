...
# validators_per_host
prep_group 1 "$VALIDATORS_MNEMONIC" 0 4 "merge-devnet-3-lighthouse-nethermind" 1000
prep_group 1 "$VALIDATORS_MNEMONIC" 4 4 "merge-devnet-3-prysm-nethermind" 1000
prep_group 1 "$VALIDATORS_MNEMONIC" 8 1 "merge-devnet-3-lodestar-nethermind" 1000
prep_group 1 "$VALIDATORS_MNEMONIC" 9 1 "merge-devnet-3-teku-nethermind" 1000
